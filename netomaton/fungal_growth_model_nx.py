...
class FungalGrowthModel_NX:
    ...
    def topology_rule(self, ctx):
        ...
        for i, j in new_map.edges:
            new_map[i][j]["weight"] = 1 / new_map.out_degree(i)
