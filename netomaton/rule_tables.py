...
def table_rule(neighbourhood, table):
    ...
    :param neighbourhood: a cellular automaton neighbourhood, where the activities are a k-color array of length 2r + 1
    ...
    """
    state_repr = ''.join(str(x) for x in neighbourhood.activities)
