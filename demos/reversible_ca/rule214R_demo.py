...
if __name__ == '__main__':
    ...
    r = ntm.ReversibleRule(initial_conditions, lambda n, c, t: ntm.rules.nks_ca_rule(n, c, 214))
    ...
    r = ntm.ReversibleRule(activities[-1], lambda n, c, t: ntm.rules.nks_ca_rule(n, c, 214))
