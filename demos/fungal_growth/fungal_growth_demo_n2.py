...
if __name__ == '__main__':
    ...
    model = ntm.FungalGrowthModel_N2(R_E, width, height, initial_conditions, seed=20210408)

    trajectory = ntm.evolve_n2(network=model.network, initial_conditions=initial_conditions, timesteps=timesteps,
